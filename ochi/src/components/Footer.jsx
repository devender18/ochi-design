export function Footer(){
    return(
        <div className="w-screen h-screen mt-12">
            <div className="w-screen flex  px-10">

                <div className="w-1/2 h-full">
                    <div className="leading-none mt-4">
                        <h1 className="text-[6vw] font-bold tracking-tighter font-spaceGrotesk">EYE-</h1>
                        <h1 className="text-[6vw] font-bold tracking-tighter font-spaceGrotesk">OPENING</h1>
                    </div>
                    <div className="mt-[31vw]">
                    <h2 className="font-semibold text-4xl ml-8"><svg width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="w-1/2 ">
                    <h1 className="text-[6vw] font-bold tracking-tighter font-spaceGrotesk">PRESENTATIONS</h1>
                    <div className="mt-10">
                        <p>S:</p>
                        <div className="mt-4"><a href="" className="underline">Instagram</a></div>
                        <a href="" className="underline">Behance</a><br/>
                        <a href="" className="underline">Facebook</a><br/>
                        <a href="" className="underline">LinkedIn</a>
                    </div>
                    <div className="flex justify-between items-center mt-10 tracking-tight capitalize">
                        <div className="">
                            <p>L:</p>
                            <div className="mt-4"><a href="" className="underline">202-1965 W 4th Ave</a></div>
                            <a href="" className="underline">Vancouver, canada</a><br/>
                            <br/>
                            <a href="" className="underline">30 chukarina St</a><br/>
                            <a href="" className="underline">Lviv, Ukraine</a><br/>
                        ...
                        <div>
                            ...
                            <a href="" className="underline">Services</a><br/>
                            <a href="" className="underline">Our work</a><br/>
                            <a href="" className="underline">About us</a><br/>
                            <a href="" className="underline">Insights</a><br/>
                            <a href="" className="underline">Contact us</a><br/>
                        </div>

                    </div>
                    <div className="mt-4">
                        <p>E:</p>
                        <div className="mt-4"><a href="">hello@ochi.design</a></div>
                    </div>

                    <div className="flex justify-between mt-8 text-gray-400">
                        <div>
                            <p>&copy; ochi design 2024. <a href="">Legal Terms</a></p>
                        </div>
